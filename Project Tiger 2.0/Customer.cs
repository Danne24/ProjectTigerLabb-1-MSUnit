...
namespace Project_Tiger_2._0
{
    public class Customer : Users
    {
...

        {
            ...
            while (logOut == false)
            {
                ...
                switch (choice)
                {
                    ...
                    case "2":
                        listOfCustomers[loggedInUserIndex].TransferMoneyToAnotherAccount(0, 1, 100);
                        break;
                    ...
                    case "4":
                        listOfCustomers[loggedInUserIndex].CreateNewBankAccount("TEST", 0, "SEK");
                        break;
        ...
        public void TransferMoneyToAnotherAccount(int accountChoice, int transferToAcount, decimal amount) // Överföring av pengar
        {
            // Console.Clear();
            // bool loop = true;
            // int accountChoice = 0;
        ...
        public void CreateNewBankAccount(string newAccountName, decimal amount, string selectedCurrency) // Skapa nytt bankkonto
        {
            //Console.Clear();
